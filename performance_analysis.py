...
class PerformanceAnalysis:
    ...
    def analyze(self):
        ...
        for function in total_execution_times:
            ...
            # print(f"  Total Execution Time: {self.convert_time_units(total_execution_times[function])}")
            # print(f"  Self Execution Time: {self.convert_time_units(self_execution_times[function])}")
            # print(f"  Average Self Time: {self.convert_time_units(average_self_times[function])}")
            # print(f"  Cumulative Execution Time: {self.convert_time_units(total_execution_times[function])}")
            # print(f"  Min Execution Time: {self.convert_time_units(min_self_times[function])}")
            # print(f"  Max Execution Time: {self.convert_time_units(max_self_times[function])}")
            # print(f"  Call Count: {call_counts[function]}")
...
if __name__ == "__main__":
    trace_data_path = "C:\\Users\\eavkhas\\Personal\\Projects\\jtelp\\log.logs"
    performance_analysis = PerformanceAnalysis(trace_data_path)
